...
export class Migration20211005232145 extends Migration {
  async up(): Promise<void> {
    this.addSql(
      'create table "itinerary_activity" ("id" bigserial primary key, "itinerary_id" int4 not null, "activity_id" int4 not null, "capacity" int4 not null, "price" decimal(8,2) null, "description" varchar(255) not null, "is_free" bool not null default false, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null);',
    );
